...
public class PokemonCollection {
	...
	public Pokemon[] getAllPokemon () {
	 ...
	 public  void initPokemonStats() {
	        ...
	        pokemon[1].setStats(new Stats(20, 4, 5, 2, 1, 5));
	        pokemon[2].setStats(new Stats(15, 3, 3, 2, 1, 3));
	        pokemon[3].setStats(new Stats(20, 4, 4, 1, 1, 4));
	        pokemon[4].setStats(new Stats(15, 5, 5, 1, 1, 5));
	        pokemon[5].setStats(new Stats(20, 3, 4, 1, 2, 3));
	        pokemon[6].setStats(new Stats(20, 3, 4, 1, 2, 2));
	        pokemon[7].setStats(new Stats(20, 3, 5, 1, 1, 4));
	        pokemon[8].setStats(new Stats(15, 4, 3, 1, 2, 5));
	        pokemon[9].setStats(new Stats(15, 3, 2, 1, 2, 3));
	        pokemon[10].setStats(new Stats(20, 5, 3, 1, 1, 4));
	        pokemon[11].setStats(new Stats(15, 4, 3, 1, 1, 6));
	        pokemon[12].setStats(new Stats(15, 6, 5, 2, 2, 7));
	        pokemon[13].setStats(new Stats(15, 4, 1, 2, 1, 2));
	        pokemon[14].setStats(new Stats(15, 5, 2, 2, 2, 4));
	        pokemon[15].setStats(new Stats(15, 3, 3, 2, 2, 3));
	        pokemon[16].setStats(new Stats(15, 5, 5, 1, 2, 6));
	        pokemon[17].setStats(new Stats(15, 5, 6, 2, 1, 5));
	        pokemon[18].setStats(new Stats(20, 5, 7, 2, 2, 4));
	        pokemon[19].setStats(new Stats(15, 4, 2, 1, 2, 4));
	    }
}
