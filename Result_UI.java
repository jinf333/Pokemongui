...
public class Result_UI extends JFrame {
    ...
    public void resultWithScore(String username, double score, Pokemon caught, Pokemon tempPokemon, boolean success, Pokeball pokeball) {
        setTitle("Result - Win");
        userLabel = new JLabel();
        ...
        if (success) {
            ...
            resultLabel.setText("Oops! You failed to catch the Pokemon [" + tempPokemon.getName() + "]using " + pokeball.getBallType());
        }
        repaint();
